          ...
          {categoriesWithCount.map((cat, index) => {
            ...
            return (
              <motion.div key={cat.id} variants={itemVariants}>
                <Link href={`/products?category=${cat.slug}`}>
                  <Card className="group glass-premium relative overflow-hidden transition-all duration-500 hover:border-[#F57224]/30 hover:scale-[1.02] hover:shadow-[0_0_30px_rgba(245,114,36,0.2)]">
                    <div className="relative overflow-hidden">
                      ...
                      {/* Hover Badge */}
                      <Badge
                        className="absolute right-3 top-3 bg-gradient-to-r from-[#F57224] to-orange-500 border-none opacity-0 transition-all duration-300 group-hover:opacity-100 group-hover:translate-x-0 translate-x-2"
                        size="sm"
                      >
                        Shop Now
                      </Badge>
