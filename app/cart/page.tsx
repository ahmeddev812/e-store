...
function CartItem({ item, onUpdate, onRemove }: any) {
  ...
  return (
    ...
    >
      <Card className="group overflow-hidden transition-all duration-300 hover:border-[#F57224]/30 hover:shadow-[0_0_30px_rgba(245,114,36,0.15)] glass-premium">
      ...
      <div className="min-h-screen overflow-x-hidden bg-background">
        ...
        <div className="relative mx-auto flex min-h-[70vh] flex-col items-center justify-center px-4">
          <motion.div
            ...
            className="mb-6 rounded-full bg-gradient-to-br from-[#F57224]/15 to-[#F57224]/5 p-8 backdrop-blur-xl"
          >
            <ShoppingBag className="size-20 text-[#F57224]/50" />
          </motion.div>
        ...
        >
          <div>
            <div className="flex items-center gap-3 mb-2">
              <div className="rounded-xl bg-gradient-to-br from-[#F57224]/15 to-[#F57224]/5 p-2">
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-[10px] text-emerald-500/60">Applied successfully</p>
                        </div>
                      </div>
                      <button
                        onClick={handleRemoveCoupon}
                        className="rounded-lg px-2 py-1 text-xs text-muted-foreground/70 hover:bg-muted/30 hover:text-foreground transition-colors"
                      >
                        Remove
                      </button>
                    </motion.div>
                      ...
                      <div className="flex gap-2">
                        {["SAVE10", "WELCOME20"].map((code) => (
                          <button
                            ...
                            className="rounded-full bg-muted/50 text-muted-foreground/70 hover:bg-[#F57224]/20 hover:text-[#F57224] px-2 py-0.5 text-[10px] transition-colors"
                          >
                            {code}
                          </button>
                        ))}
