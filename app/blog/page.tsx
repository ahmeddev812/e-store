  ...
  return (
    <div ref={sectionRef} className={`min-h-screen overflow-x-hidden bg-background`}>
      ...
      <div className={`fixed inset-0 bg-gradient-to-br from-muted/30 via-muted/10 to-background`}>
        ...
        <div className={`absolute top-1/4 right-1/4 size-48 rounded-full bg-[#D4A853]/8 blur-[100px] animate-pulse delay-500`} />
        <div className={`absolute bottom-1/4 left-1/4 size-40 rounded-full bg-[#D4A853]/4 blur-[80px] animate-pulse delay-1500`} />
      </div>
                  ...
                  <div className="space-y-2">
                    {categories.map((cat) => (
                      ...
                      >
                        ...
                        <Badge className={`bg-muted/30 text-muted-foreground/70 group-hover:bg-[#F57224]/20 group-hover:text-[#F57224] text-[9px] border-none transition-colors`}>
                          {cat.count}
                        </Badge>
                      </button>
                    ))}
      ...
      <section className="relative mx-auto max-w-7xl px-6 pb-20">
        ...
        >
          ...
          <div className="relative">
            <div className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-[#F57224]/15 to-[#F57224]/5 mb-6`}>
