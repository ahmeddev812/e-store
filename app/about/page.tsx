    ...
    <div ref={sectionRef} className="overflow-x-hidden bg-background">
      ...
      <section className="mx-auto max-w-7xl px-6 py-20">
        ...
        >
          <motion.div variants={itemVariants} className="relative">
            <div className="absolute -inset-4 rounded-3xl bg-gradient-to-r from-[#F57224]/15 via-transparent to-[#F57224]/8 blur-2xl" />
      ...
      <section className="mx-auto max-w-7xl px-6 py-20">
        ...
        <div className="relative">
          <div className="absolute left-1/2 top-0 h-full w-px bg-gradient-to-b from-[#F57224]/40 via-[#F57224]/15 to-transparent hidden lg:block" />
