        ...
        <div className="glass-card p-8">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-[#0B1120] px-2 text-white/40">or</span>
            </div>
          </div>

          <Button onClick={handleDemoLogin} className="w-full gap-2 shadow-glow">
            <LogIn className="size-4" />
            Demo Login
          </Button>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-[#0B1120] px-2 text-white/40">or continue with</span>
            </div>
          </div>

          <div className="flex gap-3">
            <Button type="button" variant="outline" disabled className="flex-1 gap-2">
          ...
          <p className="mt-6 text-center text-sm text-white/50">
            ...
            <Link href="/register" className="font-medium text-[#F57224] hover:underline">
              Create one
            </Link>
          </p>
        </div>
