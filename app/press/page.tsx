  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
      ...
      <div className="fixed inset-0 bg-gradient-to-br from-[#0a0a0f] via-[#1a0a0a] to-[#0a0a0f]">
        ...
        <div className="absolute top-1/3 right-1/4 size-64 rounded-full bg-[#D4A853]/10 blur-[100px] animate-pulse delay-500" />
      ...
      <section className="relative mx-auto max-w-7xl px-6 pb-20">
        ...
        >
          ...
          <div className="relative flex flex-col items-center gap-6 text-center md:flex-row md:text-left md:justify-between">
            ...
            <Button className="bg-gradient-to-r from-[#F57224] to-orange-500 shadow-glow hover:shadow-glow-orange shrink-0">
