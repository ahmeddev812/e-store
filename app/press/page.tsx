  ...
  return (
    <div className={`min-h-screen overflow-x-hidden bg-background`}>
      ...
      <div className={`fixed inset-0 bg-gradient-to-br from-muted/30 via-muted/10 to-background`}>
        ...
        <div className={`absolute top-1/3 right-1/4 size-64 rounded-full bg-[#D4A853]/8 blur-[100px] animate-pulse delay-500`} />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 pt-6">
        ...
        >
          <Link
            href="/"
            className={`inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-[#F57224] transition-colors`}
          >
        ...
        >
          {pressReleases.map((release, index) => (
            <motion.div key={release.title} variants={itemVariants}>
              <Card className={`glass-premium overflow-hidden transition-all duration-300 hover:border-[#F57224]/30 hover:shadow-[0_8px_40px_rgba(245,114,36,0.15)] group`}>
      ...
      <section className="relative mx-auto max-w-7xl px-6 pb-20">
        <motion.div
          ...
          viewport={{ once: true }}
          className={`glass-premium relative overflow-hidden rounded-3xl p-8 md:p-12`}
        >
          ...
          <div className="relative flex flex-col items-center gap-6 text-center md:flex-row md:text-left md:justify-between">
            <div className="space-y-2">
              <div className={`inline-flex items-center justify-center rounded-xl bg-gradient-to-br from-[#F57224]/15 to-[#F57224]/5 p-3 md:hidden`}>
      ...
      <section className="relative mx-auto max-w-7xl px-6 pb-20">
        ...
        >
          ...
          >
            <Card className={`glass-premium transition-all duration-300 hover:border-[#F57224]/30 hover:shadow-[0_8px_40px_rgba(245,114,36,0.15)]`}>
              <CardContent className="p-6 text-center">
                <div className={`mx-auto mb-4 inline-flex items-center justify-center rounded-xl bg-gradient-to-br from-[#F57224]/15 to-[#F57224]/5 p-3`}>
                ...
                <div className="mt-6">
                  <Link href="/contact">
                    <Button
                      variant="outline"
                      className={`border-border text-muted-foreground/70 hover:border-[#F57224]/50 hover:text-[#F57224]`}
                    >
                      Contact Our Team
      ...
      <section className="relative mx-auto max-w-7xl px-6 pb-20">
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className={`glass-premium relative overflow-hidden rounded-3xl p-8 text-center md:p-12`}
        >
          <div className={`absolute inset-0 bg-gradient-to-r from-[#D4A853]/4 via-transparent to-[#F57224]/8`} />
